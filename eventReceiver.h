...
public:
	...
	{   
		...
		if (event.EventType == irr::EET_MOUSE_INPUT_EVENT)
		{
			switch(event.MouseInput.Event)
			{
				...
				case irr::EMIE_LMOUSE_PRESSED_DOWN:
					if (!MouseIsDown[LMB]) MouseIsPressed[LMB] = 1;
					MouseIsDown[LMB] = 1;
					MouseWasDown[LMB] = 1;
					break;
				...
				case irr::EMIE_RMOUSE_PRESSED_DOWN:
					if (!MouseIsDown[RMB]) MouseIsPressed[RMB] = 1; 
					MouseIsDown[RMB] = 1;
					MouseWasDown[RMB] = 1;
					break;
				...
				case irr::EMIE_MMOUSE_PRESSED_DOWN:
					if (!MouseIsDown[MMB]) MouseIsPressed[MMB] = 1; 
					MouseIsDown[MMB] = 1;
					MouseWasDown[MMB] = 1;
					break;
		...
		{
			if (!KeyIsDown[event.KeyInput.Key]) KeyIsPressed[event.KeyInput.Key] = 1;
